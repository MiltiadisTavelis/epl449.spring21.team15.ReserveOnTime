                                             ...
                                             <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                   <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                      <h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;color:#F37435">RESET YOUR PASSWORD</h4>
                                                   </td>
                                                </tr>
                                                <tr style="border-collapse:collapse">
                                                ...
                                                <tr style="border-collapse:collapse">
                                                   <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-top:10px;padding-left:40px;padding-right:40px">
                                                      <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:21px;color:#333333">We received a request for a password change on reserveontime.com account. You can reset your password by clicking the button below. If you received a password reset email that you didn’t request, don’t panic! You can safely ignore it.</p>
                                                   </td>
                                                </tr>
                                                <tr style="border-collapse:collapse">
...
';
	...
	if($mail->send() == false){
		$msg['status'] = 'Password Reset Error! Please try again.';
		echo json_encode($msg);
      exit();
	}
